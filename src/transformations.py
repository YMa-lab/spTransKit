...
if __name__ == "__main__":
    ...
    plotter.plot_runtime(t_one, params.sample_id)
    plotter.plot_memory(t_one, params.sample_id)
    plotter.plot_gene_mean_var(t_one, params.sample_id)
    plotter.plot_marker_genes(t_one, genes, params.sample_id)
    plotter.plot_hvg_similarity(t_one, name, params.sample_id)
    plotter.plot_pathway_enrichment(enrichment, params.sample_id)
    plotter.plot_sf_correspondence(t_one, t_two, params.sample_id)
    plotter.plot_count_correspondence(t_one, t_two, genes, params.sample_id)
    plotter.plot_corr_matrix(t_one, params.sample_id)
    plotter.plot_total_rank(t_one, t_two, name, genes, wm, enrichment, params.sample_id)
