...
def preprocess_new(adata):
    # try:
    #     sc.pp.highly_variable_genes(adata, flavor="seurat_v3", n_top_genes=3000)
    # except Exception as e1:
    #     print(f"Error in seurat_v3: {e1}")
    #     try:
    #         sc.pp.highly_variable_genes(adata, flavor="seurat", n_top_genes=3000)
    #     except Exception as e2:
    #         print(f"Error in seurat: {e2}")
    #         try:
    #             sc.pp.highly_variable_genes(adata, flavor="cell_ranger", n_top_genes=3000)
    #         except Exception as e3:
    #             print(f"Error in cell_ranger: {e3}")
    #             print("All highly_variable_genes methods failed")
    sc.pp.highly_variable_genes(adata, flavor="cell_ranger", n_top_genes=3000)
    
    
def get_feature(adata, deconvolution=False, types ='new'):
    if deconvolution:
       adata_Vars = adata
    else: 
