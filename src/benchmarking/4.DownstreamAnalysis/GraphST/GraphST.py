import torch
from .preprocess import preprocess_adj, preprocess_adj_sparse, preprocess, construct_interaction, construct_interaction_KNN, add_contrastive_label, get_feature, permutation, fix_seed, preprocess_new
import time
import random
import numpy as np
...
class GraphST():
    def __init__(self, 
        ...
        if 'feat' not in adata.obsm.keys():
           get_feature(self.adata, types = types)
